...
//#define DPI300_PIXEL_MM 11.765f

//#define DPI_PIXEL_MM_W 13.1f
#define DPI_PIXEL_MM_W 23.6f
#define DPI_PIXEL_MM_H 23.6f
...
struct _PHOTOID_FORMAT{
	...
	void set(CString _name, int _phoW, int _phoH, int top, int bot){
		...
		photoSizeW = _phoW*DPI_PIXEL_MM_W;
		photoSizeH = _phoH*DPI_PIXEL_MM_H;
